...
- [ ] Pick a hunter
- [ ] Upload `launch/gallery/01-hero.png` (macOS feed) plus `02-feed.jpg`, `03-signin.jpg`, `04-ideas.jpg` to the PH post
- [ ] Paste `producthunt.md` tagline/description/first comment into the PH new-post form
- [ ] Note in the post that iOS is still in App Review; don't claim it's live until it flips
